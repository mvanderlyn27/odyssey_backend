    ...
    Tables: {
      ...
      session_exercises: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "session_exercises_workout_plan_day_exercise_id_fkey";
            columns: ["workout_plan_day_exercise_id"];
            isOneToOne: false;
      ...
      workout_plan_day_exercises: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "workout_plan_day_exercises_plan_workout_id_fkey";
