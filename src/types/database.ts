  ...
  public: {
    Tables: {
      ...
      workout_plan_interactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "workout_plan_reactions_workout_plan_id_fkey";
            columns: ["workout_plan_id"];
            isOneToOne: false;
            referencedRelation: "workout_plans";
            referencedColumns: ["id"];
      ...
      workout_plans: {
        Row: {
          ...
          plan_type: Database["public"]["Enums"]["workout_plan_type"] | null;
          public: boolean;
    ...
    Functions: {
      ...
      check_expired_streaks: { Args: never; Returns: undefined };
      ...
      create_full_workout_plan_rpc: {
        Args: { p_user_id: string; p_workout_plan: Json };
        Returns: string;
      };
      create_smart_workout_in_plan_rpc: {
        Args: {
          p_target_plan_id?: string;
          p_user_id: string;
          p_workout_day_data: Json;
        };
        Returns: string;
      };
      create_smart_workout_plan_rpc: {
        Args: { p_plan_data: Json; p_user_id: string };
        Returns: string;
      };
      ...
      get_workout_plan_day_full: { Args: { p_day_id: string }; Returns: Json };
      ...
      reorder_split_workouts: {
        Args: { p_day_ids: string[] };
        Returns: undefined;
      };
      reorder_workout_plan_days: {
        Args: { p_day_ids: string[] };
        Returns: undefined;
      };
      save_workout_as_new_day: {
        Args: { p_day_name: string; p_exercises: Json; p_plan_id: string };
        Returns: string;
      };
      save_workout_day_edits: {
        Args: { p_changes: Json; p_day_id: string };
        Returns: undefined;
      };
      save_workout_plan_changes: { Args: { p_changes: Json }; Returns: string };
      save_workout_split_edits: {
        Args: { p_changes: Json };
        Returns: undefined;
      };
      search_exercises:
    ...
    Enums: {
      ...
      interaction_type: "like" | "copy" | "dislike" | "view";
      ...
      workout_plan_type: "user" | "template" | "system";
    };
    CompositeTypes: {
