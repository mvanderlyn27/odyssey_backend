...
export const OnboardingV2DataSchema = Type.Object(
  {
    ...
    // New V2 Fields
    selected_muscles: Type.Optional(Type.Array(Type.String({ format: "uuid" }))),
    selected_equipment_ids: Type.Optional(Type.Array(Type.String({ format: "uuid" }))),
    equipment_preset: Type.Optional(Type.Union([Type.String(), Type.Null()])),
    notification_reminder_days: Type.Optional(Type.Union([Type.Integer(), Type.Null()])),
